...
// Enumaration, birbiri ile bağlantılı değerler için ortak bir tip oluşturur ve bu tipi kullanmanızı sağlar. Birçok dilde enumların int değerlerine atandığını biliyoruz ancak Swift programlama dilinde, enumlar daha esnek bir şekilde karşımıza çıkıyor.
...
var myFavoriteColor = PrimaryColor.blue
...
//: Enumlar kullanılarak switch statementleri tanımlanması
enum CaliforniaPark {
